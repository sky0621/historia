...
const revalidationPaths: Record<CsvSyncImportTarget, string[]> = {
  ...
  "person-region-links": ["/person", "/regions", "/manage/data"],
  "person-tag-links": ["/person", "/tags", "/manage/data"],
  "person-religion-links": ["/person", "/religions", "/manage/data"],
