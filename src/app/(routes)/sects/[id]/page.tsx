        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            {view.relatedPerson.length > 0 ? (
              <Link href={`/person?sectId=${view.sect.id}`} className="underline-offset-4 hover:underline">
            ...
            {view.relatedEvents.length > 0 ? (
              <Link href={`/events?sectId=${view.sect.id}`} className="underline-offset-4 hover:underline">
